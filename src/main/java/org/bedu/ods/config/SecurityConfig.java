    ...
    SecurityFilterChain springWebFilterChain(HttpSecurity http,
        ...
        return http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/usuario").hasAnyAuthority("USER", "ROLE_USER")
                        .requestMatchers("/api/manager").hasAnyAuthority("MANAGER", "ROLE_MANAGER")
                        .requestMatchers("/api/admin").hasAnyAuthority("ADMIN", "ROLE_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/usuarios/**").hasAnyAuthority("ADMIN" ,"ROLE_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/proyectos/**").hasAnyAuthority("ADMIN" ,"MANAGER", "ROLE_ADMIN", "ROLE_MANAGER")
                        .requestMatchers(HttpMethod.DELETE, "/tareas/**").hasAnyAuthority( "MANAGER", "USER", "ROLE_MANAGER", "ROLE_USER")
